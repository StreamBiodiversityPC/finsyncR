...
## Installation
You can install the released version of `finsyncR` from [GitHub](https://github.com/StreamBiodiversityPC/finsyncR) with:
...
For information on how to contribute to the `finsyncR` package, please see the [contributing to finsyncR document](https://github.com/StreamBiodiversityPC/finsyncR/blob/main/CONTRIBUTING.md).
